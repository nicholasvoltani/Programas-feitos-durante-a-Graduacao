...
Tenha-se uma sequência de grafos de Erdős-Rényi *(G(N,p))<sub>N=2</sub><sup>∞</sup>*, definidos de tal forma que:
<p align = "center"> 
...
Desejamos avaliar como a máxima verossimilhança evolui conforme <img src="https://latex.codecogs.com/png.latex?\inline&space;\bg_white&space;N \to \infty" />
